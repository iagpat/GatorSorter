...
public:
	...
	int64_t absolute_threshold_in_micro_volts = 30; //If threshold sign is negative then it will be -30, is it is positive it will be +40 and if notit will be zero.  
